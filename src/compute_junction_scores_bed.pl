...
#print STDERR "DEBUG: line $line\n";
  ...
  if($bed_fields[0] eq "don"){
    print STDERR "DEBUG donor $donor_seq $bed_fields[3] $bed_fields[4]\n";
    ...
    print STDERR "DEBUG acceptor $acceptor_seq $bed_fields[3] $bed_fields[4]\n";
    ...
    print STDERR "DEBUG pair $pair_seq $bed_fields[4] $max_len\n";
  }
}
